...
public:
    VulkanShader(VulkanContext* context, const std::string& name, const std::string& v_path, const std::string& f_path);
    ...
    inline const vk::raii::ShaderModule& GetVertexModule() const { return _vertexModule; }
    inline const vk::raii::ShaderModule& GetFragmentModule() const { return _fragmentModule; }
